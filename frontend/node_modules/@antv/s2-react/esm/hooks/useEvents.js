...
export const useCellEvent = (eventName, handler, s2) => {
...
export const useS2Event = (eventName, handler, s2, emitBeforeOff = false) => {
    React.useLayoutEffect(() => {
...
export function useEvents(props, s2) {
    // ============== Row Cell ====================
    ...
    useS2Event(S2Event.COL_CELL_EXPAND_ICON_HOVER, props.onColCellExpandIconHover, s2);
    ...
    useS2Event(S2Event.DATA_CELL_BRUSH_SELECTION, props.onDataCellBrushSelection, s2);
    ...
    useCellEvent(S2Event.CORNER_CELL_CONTEXT_MENU, props.onCornerCellContextMenu, s2);
    ...
    useCellEvent(S2Event.MERGED_CELLS_CONTEXT_MENU, props.onMergedCellsContextMenu, s2);
    ...
    /** ================ SeriesNumber Cell ================  */
    useS2Event(S2Event.SERIES_NUMBER_CELL_RENDER, props.onSeriesNumberCellRender, s2);
    // ============== Sort ====================
    ...
    // ============== Auto 自动生成的 ================
    useS2Event(S2Event.LAYOUT_AFTER_REAL_DATA_CELL_RENDER, props.onLayoutAfterRealDataCellRender, s2);
    useS2Event(S2Event.ROW_CELL_BRUSH_SELECTION, props.onRowCellBrushSelection, s2);
    useS2Event(S2Event.COL_CELL_BRUSH_SELECTION, props.onColCellBrushSelection, s2);
}

...
import type { BaseCell, ColCell, CornerCell, DataCell, MergedCell, RowCell, TableCornerCell, TableDataCell, TableSeriesNumberCell } from '../../cell';
...
import type { CellType, InteractionName, InteractionStateName, InterceptType, ScrollbarPositionType } from '../constant';
...
export type S2CellType<T extends SimpleBBox = ViewMeta> = DataCell | HeaderCell | ColCell | CornerCell | RowCell | SeriesNumberCell | MergedCell | TableDataCell | TableCornerCell | TableSeriesNumberCell | BaseCell<T>;
...
export type OnUpdateCells = (root: RootInteraction, defaultOnUpdateCells: () => void) => void;
...
export interface InteractionOptions {
     ...
     */
    autoResetSheetStyle?: boolean | ((event: Event | FederatedPointerEvent, spreadsheet: SpreadSheet) => boolean);
    /**
...
export interface ScrollOffsetConfig extends Pick<CellScrollToOptions, 'skipScrollEvent'> {
    /**
     * 行头水平偏移量
     */
    rowHeaderOffsetX?: {

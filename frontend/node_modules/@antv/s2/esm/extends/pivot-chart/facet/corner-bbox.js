...
export class CornerBBox extends OriginCornerBBox {
    calculateOriginWidth() {
        ...
        const rowAxisWidth = (_a = axisRowsHierarchy === null || axisRowsHierarchy === void 0 ? void 0 : axisRowsHierarchy.width) !== null && _a !== void 0 ? _a : 0;
        this.originalWidth = floor(this.facet.getSeriesNumberWidth() + rowsHierarchy.width + rowAxisWidth);
    }
}

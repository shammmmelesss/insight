...
import { CellType, InteractionBrushSelectionStage, InteractionName, InteractionStateName, } from '../../common/constant/interaction';
...
export class DataCellBrushSelection extends BaseBrushSelection {
    constructor() {
        ...
        this.getSelectedCellMetas = (brushRange) => {
            ...
            const rowIndexRange = range(brushRange.start.rowIndex, brushRange.end.rowIndex + 1);
            const colIndexRange = range(brushRange.start.colIndex, brushRange.end.colIndex + 1);

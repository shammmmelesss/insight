...
import { CELL_PADDING, FONT_FAMILY, INTERVAL_BAR_HEIGHT, } from '../common/constant';
import { isMobile, isWindows } from '../utils/is-mobile';
import { getPalette } from '../utils/theme';
export const DEFAULT_FONTSIZE = 12;
export const getCornerCellTheme = (palette, spreadsheet) => {
    var _a, _b;
...
export const getRowCellTheme = (palette, spreadsheet) => {
    var _a, _b;
    const { basicColors, others: otherColors } = palette;
    const isTable = spreadsheet === null || spreadsheet === void 0 ? void 0 : spreadsheet.isTableMode();
    const boldTextDefaultFontWeight = isWindows() ? 'bold' : 700;
...
export const getColCellTheme = (palette) => {
    var _a, _b;
    const { basicColors, others: otherColors } = palette;
    const boldTextDefaultFontWeight = isWindows() ? 'bold' : 700;
    return {
...
export const getDataCellTheme = (palette) => {
    var _a, _b;
 ...
 * @param themeCfg
 */
export const getTheme = (themeCfg) => {
    var _a;
    const palette = (themeCfg === null || themeCfg === void 0 ? void 0 : themeCfg.palette) || getPalette(themeCfg === null || themeCfg === void 0 ? void 0 : themeCfg.name);

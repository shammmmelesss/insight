...
import { DEFAULT_FONT_COLOR, REVERSE_FONT_COLOR, } from '../common/constant/condition';
 ...
 * @param color
 */
export const shouldReverseFontColor = (color) => tinycolor(color).getLuminance() <= 0.5;
/**
 * @param backgroundColor
 * @param fontColor
 */
export const isReadableText = (backgroundColor, fontColor) => {
 ...
 * @returns 标准色卡
 */
export const generateStandardColors = (brandColor) => {
 ...
 * @returns 新色板
 */
export const generatePalette = (paletteMeta = {}) => {
    const basicColors = Array.from(Array(BASIC_COLOR_COUNT)).fill(REVERSE_FONT_COLOR);

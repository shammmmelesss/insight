...
export const getIconPosition = (condition) => { var _a; return (_a = condition === null || condition === void 0 ? void 0 : condition.position) !== null && _a !== void 0 ? _a : 'right'; };
/*
...
export const findFieldCondition = (conditions = [], field) => {

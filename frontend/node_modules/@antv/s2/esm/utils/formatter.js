 ...
 * @param formatter
 */
export const auto = (v, fixed = 2, formatter = FORMATTERS[getLang()] || FORMATTERS.zh_CN) => {
 ...
 */
export const parseNumberWithPrecision = (value) => Number.parseFloat((toNumber(value) || 0).toPrecision(PRECISION));

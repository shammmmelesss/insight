...
class AxisRowCell extends s2_1.RowCell {
    get cellType() {
        return cell_type_1.AxisCellType.AXIS_ROW_CELL;
    }
    getBorderPositions() {
        return [s2_1.CellBorderPosition.BOTTOM, s2_1.CellBorderPosition.LEFT];
    }
    isBolderText() {
        return false;
    }
    getInteractedCells() {
        ...
        return (_a = this.spreadsheet.interaction) === null || _a === void 0 ? void 0 : _a.getCells([
            s2_1.CellType.ROW_CELL,
            cell_type_1.AxisCellType.AXIS_ROW_CELL,
        ]);
    }
    initCell() {
    ...
    getResizesArea() {
        return (0, s2_1.getOrCreateResizeAreaGroupById)(this.spreadsheet, constant_1.KEY_GROUP_ROW_AXIS_RESIZE_AREA);
    }
    drawTextShape() {
    ...
    getChartOptions() {
        ...
        return (0, s2_1.customMerge)(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, constant_1.DEFAULT_G2_SPEC), this.getBBoxByType(s2_1.CellClipBox.CONTENT_BOX)), (0, chart_options_1.getCoordinate)(this.spreadsheet)), (this.spreadsheet.isValueInCols()
            ? (0, chart_options_1.getAxisXOptions)(this.meta, this.spreadsheet)
            : (0, chart_options_1.getAxisYOptions)(this.meta, this.spreadsheet))), (0, chart_options_1.getAxisStyle)(style)), (0, chart_options_1.getTheme)(this.spreadsheet)), customSpec);
    }
    drawAxisShape() {
...
exports.AxisRowCell = AxisRowCell;

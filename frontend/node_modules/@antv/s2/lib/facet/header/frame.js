...
class Frame extends g_1.Group {
    ...
    onBorderScroll(scrollX) {
        if (scrollX !== this.cfg.scrollX) {
            ...
            (0, utils_1.translateGroup)(this, position.x - scrollX, 0);
            this.render();
        }
    }
    onChangeShadowVisibility(scrollX, maxScrollX) {
        ...
        const showViewportRightShadow = trailingColCount === 0 && (0, math_1.floor)(scrollX) < (0, math_1.floor)(maxScrollX);
    ...
    addCornerBottomBorder() {
        ...
        this.cornerBottomBorder = (0, g_renders_1.renderLine)(this, {
            x1,
            y1: y,
            x2,
            y2: y,

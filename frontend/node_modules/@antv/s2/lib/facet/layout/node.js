...
const node_1 = require("../../common/constant/node");
/**
...
class Node {
    ...
    static getFieldPath(node, isDrillDown) {
        if ((node && !node.isTotals) || (node && isDrillDown)) {
            ...
            while (parent && parent.id !== node_1.ROOT_NODE_ID) {
    ...
    getHeadLeafChild() {
        ...
        let leafChild = this;
        while (!(0, lodash_1.isEmpty)(leafChild === null || leafChild === void 0 ? void 0 : leafChild.children)) {
            leafChild = (0, lodash_1.head)(leafChild === null || leafChild === void 0 ? void 0 : leafChild.children);
        }
        return leafChild;
    }
    /**
    ...
    getTotalHeightForTreeHierarchy() {
        if (this.height === 0 || (0, lodash_1.isEmpty)(this.children)) {
            return this.height;
        }
        return this.children.reduce((sum, child) => sum + child.getTotalHeightForTreeHierarchy(), this.height);
    }
    isSeriesNumberNode() {
        return this.field === common_1.SERIES_NUMBER_FIELD;
    }
    clone() {

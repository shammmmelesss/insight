...
exports.adjustTextIconPositionWhileScrolling = void 0;
const normalize_1 = require("../normalize");
/**
 * 动态调整滚动过程中列头的可视区域
 */
const adjustTextIconPositionWhileScrolling = (viewportArea, contentArea, style, options) => {
    ...
    if (paddingArea.start < viewportArea.start &&
        ...
        const area = {
            start: viewportArea.start +
                (align !== normalize_1.NormalizedAlign.End ? padding.start : 0),
    ...
    if (paddingArea.start >= viewportArea.start &&
        ...
        const area = {
            ...
            size: contentArea.size -
                ...
                (align !== normalize_1.NormalizedAlign.Start ? padding.end : 0),
        };
        if (area.size < totalSize) {
            area.size = totalSize;
...
exports.adjustTextIconPositionWhileScrolling = adjustTextIconPositionWhileScrolling;
